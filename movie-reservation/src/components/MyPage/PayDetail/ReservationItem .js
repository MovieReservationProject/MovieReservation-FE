...
function ReservationItem({ reservation, reservations }) {
  ...
  const navigateTochangereservemovie = (
    myreserveNum,
    mytitleKorean,
    mycinemaName,
    mymoviedate,
    ...
    navigate(`/reservationChange/${myreserveNum}`, {
      state: {
        myreserveNum,
        mytitleKorean,
        mycinemaName,
                ...
                <ul className="reservation-mv-info">
                  ...
                  <li>
                    <dl>
                      <dt>관람일시</dt>
                      <dd>
                        {reservation.movieDate} {reservation.startTime}
                      </dd>
                    </dl>
                  </li>
                </ul>
          ...
          <div className="set-btn">
            <div className="col-print">
              ...
              <button
                ...
                data-status="94"
                onClick={() =>
                  navigateTochangereservemovie(
                    reservation.reserveNum,
                    reservation.titleKorean,
